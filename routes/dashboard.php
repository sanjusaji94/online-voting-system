...
<html>
    ...
    <meta charset="UTF-8">
        ...
        <style>
            ...
            background-color: rgb(164, 191, 210);
            }
            </style>
    </head>
    <body>
    ...
    <li><div id="headerSection">
            ...
            <div id="mainSection">
                <div id="profileSection">
                    <h2 style="color:green">Voter Details</h2>
                    ...
                    <b>Voterid : </b><?php echo $data['voterid'] ?><br><br>
                    <b>Address : </b><?php echo $data['address'] ?><br><br>
                    <b>Age : </b><?php echo $data['age'] ?><br><br>
                ...
                <div id="groupSection">
                    ...
                    if(isset($_SESSION['groups'])){
                        ...
                        for($i=0; $i<count($groups); $i++){
                            ?>
                                <div style="border-bottom: 2px solid #bdc3c7; margin-bottom: 50px">
                                <img style="float: right" src="../uploads/<?php echo $groups[$i]['photo']?>" height="70" width="80">
